...
export const fetchCards = async (page?: string): Promise<ElderCardPage> => {
  ...
  //   page ?? `${BASE_URL}/cards?page=1&pageSize=${DEFAULT_PAGE_SIZE}`
  // );
  // const json = await res.json();
  return convertToElderCardsPage(mock);
};
...
const mock = {
  cards: [
    ...
    },
    {
      ...
      unique: false,
      imageUrl:
        "https://images.elderscrollslegends.io/cs/shimmerene_peddler.png",
    ...
    },
    {
      ...
      unique: false,
      imageUrl:
        "https://images.elderscrollslegends.io/cs/protective_spider.png",
